...
CREATE TABLE `account` (
  `acc_id` int NOT NULL COMMENT 'TRIAL',
  `acc_type` varchar(255) NOT NULL COMMENT 'TRIAL',
  `status` varchar(255) NOT NULL COMMENT 'TRIAL',
  `trial791` char(1) DEFAULT NULL COMMENT 'TRIAL',
  PRIMARY KEY (`acc_id`)
...
INSERT INTO `account` VALUES (1,'Savings','Active','T'),(2,'Savings','Active','T'),(3,'Savings','Active','T');
